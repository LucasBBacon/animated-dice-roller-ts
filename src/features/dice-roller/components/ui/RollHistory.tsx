...
export const RollHistory: React.FC = () => {
  ...
  return (
    <div className={`roll-history-container ${isOpen ? "open" : "closed"}`}>
      <button className="ledger-tab" onClick={() => setIsOpen(!isOpen)}>
        {isOpen ? "◀" : "📜 Ledger"}
      </button>

      <div className="roll-history">
        <h3 className="history-title">
          <span className="drop-cap">H</span>istory of Rolls
        </h3>
